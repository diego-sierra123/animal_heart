    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                $consultaTotal = "SELECT COUNT(*) as total FROM cita";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3" style="margin-left: 0; padding-left: 0;">
                            <a href="insert.php" class="btn btn-success m-2">+ Agregar Cita</a>
                            <a href="selectdia.php" class="btn btn-info ms-2 m-2">Citas del Día</a>
                        </div>
                    </div>
                </div>
                <br>
                <form id="search-form" class="search-form" style="justify-content: flex-start; margin-left: 0; padding-left: 0;">
                    <input type="text" id="search-input" placeholder="Buscar por nom, ape, doc del cliente o fecha..." style="margin-left: 0; width: 500px;">
                        ...
                        <table class="table table-hover table-striped table-sm text-center align-middle w-100 tabla-veterinaria" style="border: 2px solid black; font-size: 0.9rem;">
                            ...
                            <tbody id="tabla-body">
                                ...
                                ?>
                                        <tr style="border: 1px solid black;">
                                            ...
                                            <td class="align-middle">
                                                <?php if ($idest == 1) { ?>
                                                    <a class="btn btn-primary btn-sm py-0 px-1" href="update.php?actualizar=<?php echo $id_cita; ?>" style="font-size: 0.7rem;">
                                ...
                                <?php
                                    ...
                                    echo '<tr><td colspan="10" class="text-center align-middle">No hay citas registradas.</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
