        ...
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-10 col-sm-8 col-md-7 col-lg-6 custom-border background-image">
                    ...
                    <form class="mt-3" action="updatedia.php" method="post">
                        <br>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10 col-sm-8 col-md-7 col-lg-6 m-4 text-center">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="selectdia.php" class="btn btn-secondary m-2">Atrás</a>
                                    </div>
                                    <div class="col">
                            ...
                            if (empty($idPac) || empty($fec) || empty($hor) || empty($cli) || empty($mas) || empty($est) || empty($ser)) {
                                echo '<script type="text/javascript">
                                    swal({
                                        ...
                                        window.open("updatedia.php?actualizar=' . $idPac . '", "_SELF");
                                    });
                                </script>';
                            } else {
