        ...
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-10 col-sm-8 col-md-7 col-lg-6 custom-border background-image">
                    <h2 class="text-light mt-3 text-center" style="font-weight: bold; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8); color: #fff;"><b>AGREGAR DESPARASITANTE</b></h2>
                    ...
                    if (isset($_POST["insertar"])) {
                        ...
                        if (empty($nom)) {
                            ...
                            $sql = "INSERT INTO desparasitante (nombre) 
                                    VALUES ('$nom')";
                            ...
                            if ($ejecutar) {
                                ...
                                swal({
                                    title: "Mensaje",
                                    text: "Desparasitante guardado exitosamente.",
                                    icon: "success",
                                    showCancelButton: false,
                                    confirmButtonText: "OK"
                                }).then(function() {
                                ...
                                swal({
                                    title: "Error",
                                    text: "Hubo un problema al guardar el desparasitante: ' . addslashes(mysqli_error($conexion)) . '",
                                    icon: "error",
                                    showCancelButton: false,
                                    confirmButtonText: "OK"
                                });
