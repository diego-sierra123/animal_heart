    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM desparasitante");
                ...
                $consulta = "SELECT id_desparasitante, nombre FROM desparasitante  ORDER BY id_desparasitante ASC LIMIT $desde, $regitros";
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="row mb-3">
                            <div class="col-12">
                                <a href="insert.php" class="btn btn-success m-2" style="margin-top: 10px;">+ Agregar Desparasitante</a>
                                <a href="../servicio/select.php" class="btn btn-dark m-2" style="margin-left: 10px; margin-top: 10px;">Regresar a Servicios</a>
                ...
                <form id="search-form" class="search-form">
                    <input type="text" id="search-input" placeholder="Ingrese el nombre de la desparasitante...">
                ...
                if (isset($_GET['eliminar'])) {
                    ...
                    $consulta_relacionada = "SELECT id_historial_clinico FROM historial_clinico WHERE id_desparasitante='$borrar_id'";
                    ...
                    if ($puede_eliminar) {
                        $eliminar = "DELETE FROM desparasitante WHERE id_desparasitante='$borrar_id'";
