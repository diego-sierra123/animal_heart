    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM estado_cita");
                ...
                $consulta = "SELECT id_estado_cita, nombre FROM estado_cita  ORDER BY id_estado_cita ASC LIMIT $desde, $regitros";
                ...
                <form id="search-form" class="search-form">
                    <input type="text" id="search-input" placeholder="Ingrese el nombre del estado de la cita...">
                ...
                if (isset($_GET['eliminar'])) {
                    ...
                    $consulta_relacionada = "SELECT id_cita FROM cita WHERE id_estado_cita='$borrar_id'";
                    ...
                    if ($puede_eliminar) {
                        $eliminar = "DELETE FROM estado_cita WHERE id_estado_cita='$borrar_id'";
