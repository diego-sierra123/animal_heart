    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                $consultaTotalRegistros = "SELECT COUNT(*) as total FROM cita WHERE id_ver = 2";
                ...
                if (isset($_GET['marcar_leido'])) {
                    ...
                    $actualizar = "UPDATE cita SET id_ver = 1 WHERE id_cita='$marcar_id'";
...
<script>
    function marcarComoLeido(idCita) {
        Swal.fire({
            ...
            text: 'Esta notificación será marcada como leída y ya no aparecerá en esta sección.',
            icon: 'question',
