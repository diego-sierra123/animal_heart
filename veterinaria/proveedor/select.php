    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                $consulta = "SELECT id_proveedor, nombre, nit, telefono FROM proveedor  ORDER BY id_proveedor ASC LIMIT $desde, $regitros";
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="row mb-3">
                            <div class="col-12">
                                <a href="insert.php" class="btn btn-success m-2">+ Agregar Proveedor</a>
                                <a href="../compra_proveedor/select.php" class="btn btn-success m-2">Compras a los Proveedores</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="search-form" class="search-form">
                    <input type="text" id="search-input" placeholder="Ingrese el nombre del proveedor...">
                ...
                if (isset($_GET['eliminar'])) {
                    ...
                    $consulta_relacionada = "SELECT id_compra_proveedor FROM compra_proveedor WHERE id_proveedor='$borrar_id'";
                    $ejecutar_relacionada = mysqli_query($conexion, $consulta_relacionada);

                    $consulta_relacionada_otra_tabla = "SELECT id_articulo FROM articulo WHERE id_proveedor='$borrar_id'";
                    ...
                    if ($puede_eliminar) {
                        $eliminar = "DELETE FROM proveedor WHERE id_proveedor='$borrar_id'";
