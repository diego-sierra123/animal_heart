        ...
        <div class="row justify-content-center">
            ...
            <div class="row text-center">
                <h1 class="mt-3 text-center titulo-veterinaria">
                    CANTIDAD DE ARTÍCULOS INCLUYENDO EL STOCK
                </h1>
            </div>
            ...
            <div id="table-container">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <a href="pdf1.php" class="btn btn-danger m-2" target="_blank">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-sm text-center align-middle w-100 tabla-veterinaria" style="border: 2px solid black; font-size: 0.9rem;">
                            ...
                            <tbody>
                                ...
                                $consulta = "SELECT COUNT(*) AS cantidad_de_articulos, SUM(valor * stock) AS valor_total 
                                            FROM articulo 
