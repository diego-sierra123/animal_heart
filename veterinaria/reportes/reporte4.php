        ...
        <div class="row justify-content-center">
            ...
            <div class="row text-center">
                <h1 class="mt-3 text-center titulo-veterinaria">
                    CANTIDAD DE MASCOTAS QUE CONTIENE LA VETERINARIA
                </h1>
            </div>
            ...
            <div id="table-container">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <a href="pdf4.php" class="btn btn-danger m-2" target="_blank">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-sm text-center align-middle w-100 tabla-veterinaria" style="border: 2px solid black; font-size: 0.9rem;">
                            ...
                            <tbody>
                                ...
                                $consulta = "SELECT COUNT(*) AS cantidadmascotas FROM mascota";
                                ...
                                if (mysqli_num_rows($sql) > 0) {
                                    while ($datos = mysqli_fetch_assoc($sql)) {
                                        ...
                                        echo '<td class="align-middle">' . number_format($datos['cantidadmascotas'], 0) . '</td>';
                                        echo '</tr>';
                                    }
                                } else {
                                    echo '<tr><td colspan="2" class="text-center align-middle">No hay datos disponibles</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
