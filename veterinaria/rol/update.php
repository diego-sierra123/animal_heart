    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            if (isset($_GET['actualizar'])) {
                ...
                $consulta = "SELECT * FROM rol WHERE id_rol = '$editarId'";
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-10 col-sm-8 col-md-7 col-lg-6 custom-border background-image">
                    <h2 class="text-light mt-3 text-center" style="font-weight: bold; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8); color: #fff;"><b>ACTUALIZAR ROL</b></h2>
                    ...
                    <form class="row justify-content-center align-content-center g-3 mt-3" name="insert" action="update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-10 col-sm-8 col-md-7 col-lg-7 text-light d-none">
                            <label for="" class="form-label" style="font-size: 20px; font-weight: bold; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8); color: #fff;">Id Rol:</label>
                        ...
                        <div class="col-10 col-sm-8 col-md-7 col-lg-6 m-4 text-center">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="../rol/select.php" class="btn btn-secondary m-2">Atrás</a>
                                </div>
                                <br>
                                <div class="col">
