    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM nom_servicio");
                ...
                $consulta = "SELECT id_nom_servicio, nombre FROM nom_servicio  ORDER BY id_nom_servicio ASC LIMIT $desde, $regitros";
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="row mb-3">
                            <div class="col-12">
                                <a href="insert.php" class="btn btn-success">+ Agregar Servicio</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="row mb-3">
                            <div class="col-12">
                                <h3 id="unicohtres" class="mt-3" style="font-weight: bold;">Servicios para el historial clínico de las mascotas</h3>
                                <br>
                                <a href="../vacuna/select.php" class="btn btn-success boton m-2">Vacunas</a>
                                <a href="../desparasitante/select.php" class="btn btn-success botonnn m-2">Desparasitantes</a>
                                <br>
                                <br>
                            </div>
                        </div>
                ...
                <form id="search-form" class="search-form">
                    <input type="text" id="search-input" placeholder="Ingrese el nombre del servicio...">
                ...
                if (isset($_GET['eliminar'])) {
                    ...
                    $consulta_relacionada = "SELECT id_cita FROM cita WHERE id_nom_servicio='$borrar_id'";
                    ...
                    if ($puede_eliminar) {
                        $eliminar = "DELETE FROM nom_servicio WHERE id_nom_servicio='$borrar_id'";
