    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM tipo_articulo");
                ...
                $consulta = "SELECT id_tipo_articulo, nombre FROM tipo_articulo  ORDER BY id_tipo_articulo ASC LIMIT $desde, $regitros";
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="row mb-3">
                            <div class="col-12">
                                <a href="insert.php" class="btn btn-success" style="margin-top: 10px;">+ Agregar Tipo Artículo</a>
                                <a href="../articulo/select.php" class="btn btn-dark " style="margin-left: 10px; margin-top: 10px;">Regresar a Artículos</a>
                ...
                <form id="search-form" class="search-form">
                    <input type="text" id="search-input" placeholder="Ingrese el nombre del tipo de artículo...">
                ...
                if (isset($_GET['eliminar'])) {
                    ...
                    $consulta_relacionada = "SELECT id_articulo FROM articulo WHERE id_tipo_articulo='$borrar_id'";
                    $ejecutar_relacionada = mysqli_query($conexion, $consulta_relacionada);

                    $consulta_relacionada_otra_tabla = "SELECT id_detalle_factura FROM detalle_factura WHERE id_tipo_articulo='$borrar_id'";
                    $ejecutar_relacionada_otra_tabla = mysqli_query($conexion, $consulta_relacionada_otra_tabla);

                    $consulta_relacionada_otra_tabla_two = "SELECT id_detalle_factura_temp FROM detalle_factura_temp WHERE id_tipo_articulo='$borrar_id'";
                    $ejecutar_relacionada_otra_tabla_two = mysqli_query($conexion, $consulta_relacionada_otra_tabla_two);

                    if (
                        ($ejecutar_relacionada && mysqli_num_rows($ejecutar_relacionada) > 0) || ($ejecutar_relacionada_otra_tabla && mysqli_num_rows($ejecutar_relacionada_otra_tabla) > 0) || ($ejecutar_relacionada_otra_tabla_two && mysqli_num_rows($ejecutar_relacionada_otra_tabla_two) > 0)
                    ) {
                        $puede_eliminar = false;
                    }

                    if ($puede_eliminar) {
                        $eliminar = "DELETE FROM tipo_articulo WHERE id_tipo_articulo='$borrar_id'";
