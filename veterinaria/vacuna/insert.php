        ...
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-10 col-sm-8 col-md-7 col-lg-6 custom-border background-image">
                    <h2 class="text-light mt-3 text-center" style="font-weight: bold; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8); color: #fff;"><b>AGREGAR VACUNA</b></h2>
                    ...
                    if (isset($_POST["insertar"])) {
                        ...
                        if (empty($nom)) {
                            ...
                            if ($ejecutar) {
                                ...
                                swal({
                                    title: "Mensaje",
                                    text: "Vacuna guardado exitosamente.",
                                    icon: "success",
                                    showCancelButton: false,
                                    confirmButtonText: "OK"
                                }).then(function() {
                                ...
                                swal({
                                    title: "Error",
                                    text: "Hubo un problema al guardar la vacuna: ' . addslashes(mysqli_error($conexion)) . '",
                                    icon: "error",
                                    showCancelButton: false,
                                    confirmButtonText: "OK"
                                });
