    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div id="table-container">
                ...
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM vacuna");
                ...
                $consulta = "SELECT id_vacuna, nombre FROM vacuna  ORDER BY id_vacuna ASC LIMIT $desde, $regitros";
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="row mb-3">
                            <div class="col-12">
                                <a href="insert.php" class="btn btn-success m-2" style="margin-top: 10px;">+ Agregar Vacuna</a>
                ...
                <form id="search-form" class="search-form">
                    <input type="text" id="search-input" placeholder="Ingrese el nombre de la vacuna...">
                ...
                if (isset($_GET['eliminar'])) {
                    ...
                    $consulta_relacionada = "SELECT id_historial_clinico FROM historial_clinico WHERE id_vacuna='$borrar_id'";
                    ...
                    if ($puede_eliminar) {
                        $eliminar = "DELETE FROM vacuna WHERE id_vacuna='$borrar_id'";
